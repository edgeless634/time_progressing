...
#define ANIMATION_DELAY          5// The delay time of animation
...
public:
    ...
    /**
     * Change the status of pixel at position (x,y).
     */
    void setPixel(byte x, byte y, bool isOn);
     ...
     */
    void animation_show(byte icon[8]);
